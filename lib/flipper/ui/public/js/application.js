document.addEventListener("DOMContentLoaded", function () {
  ...
  if (expressionForm) {
    ...
    function addExpressionRow(property, operator, value) {
      ...
      setTimeout(function() {
        var addedPropertySelect = expressionList.querySelector('select[name="complex_expressions[' + expressionCounter + '][property]"]');
        var addedOperatorSelect = expressionList.querySelector('select[name="complex_expressions[' + expressionCounter + '][operator]"]');
